...
from cstargslt_model import GatedSLNNStep

# Load the trained model
try:
    MODEL_FILEPATH = 'Trained Models/cstargslt_mnist.keras'
...
# python cstargslt_deploy.py
# Remarks: 47% confidence but predicted correct (Passed but still an Outlier)
