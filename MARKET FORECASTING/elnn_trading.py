...
def build_lnn_model(input_shape, reservoir_dim, spectral_radius, leak_rate):
    """Builds and compiles the Elastic Liquid Neural Network model."""
    ...
    outputs = layers.Dense(1, activation='linear')(lnn_output)
...
def main():
    ...
    # Step 4: Build and Train LNN Model
    model = build_lnn_model((backcandles, X_train.shape[2]), reservoir_dim, spectral_radius, leak_rate)
