...
def create_gslnn_model(input_dim, reservoir_dim, spectral_radius, leak_rate, spike_threshold, max_reservoir_dim, output_dim):
    ...
    lnn_output = Lambda(apply_gated_slnn)(inputs)
...
def main():
    ...
    model = create_gslnn_model(input_dim, reservoir_dim, spectral_radius, leak_rate, spike_threshold, max_reservoir_dim, output_dim)
