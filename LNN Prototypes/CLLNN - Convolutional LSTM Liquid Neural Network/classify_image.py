...
from cllnn_model import LNNStep  # Import custom layer
import sys
...
def load_model(model_path):
    ...
    return tf.keras.models.load_model(
        model_path,
        custom_objects={'LNNStep': LNNStep}  # Adjust if using a different custom layer class name
    )
...
def main():
    ...
    model_path = 'TrainedModels/cllnn_model.keras'  # Adjust to your model path
...
# python classify_image.py img_5.png
